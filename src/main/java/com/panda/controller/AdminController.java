...
public class AdminController {
	...
	/*
	 * @RequestMapping(value = "/index") public String mainGET()throws Exception{
	 * mylog.debug(" mainGET() 호출 "); String id =
	 * (String)session.getAttribute("user_id"); resultURI = ""; if(id == null ||
	 * !id.equals("admin")) {
	 * 
