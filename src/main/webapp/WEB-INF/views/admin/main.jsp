						...
						<div class="p-t-15">
							...
							<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
								<select class="js-select2 select2-hidden-accessible" name="time"
									...
									dir="ltr" style="width: 143px;"><span class="selection"><span
										class="select2-selection select2-selection--single"
										role="combobox" aria-haspopup="true" aria-expanded="false"
										tabindex="0" aria-labelledby="select2-time-le-container"><span
											class="select2-selection__rendered"
											id="select2-time-le-container" title="Select a country...">Select
												a country...</span><span class="select2-selection__arrow"
